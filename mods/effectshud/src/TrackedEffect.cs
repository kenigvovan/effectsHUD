...
namespace effectshud.src
{
    public class TrackedEffect
    {
        ...
        public Vintagestory.API.Common.Func<int> getTextureNumber { get; set; } = null;
        public bool active { get; set; } = false;
        public int activeTexture { get; set; } = 0;

        public TrackedEffect(AssetLocation [] assetLocation, bool showTime, string watchedBranch, string effectWatchedName, string effectDurationWatchedName, Vintagestory.API.Common.Func<int> checkAction)
        {
